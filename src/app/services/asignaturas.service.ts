...
export class AsignaturasService {
  ...
  allAsignaturasDam: Asignatura[] = [];
  allAsignaturasDaw: Asignatura[] = [];
  allAsignaturas: Asignatura[] = [];
  allCiclosAsignaturas:Asignatura[]=[];

  constructor() {}

  getAllAsignaturasDam(): Asignatura[] {
  ...
  getAllAsignaturasDaw(): Asignatura[] {
    this.allAsignaturasDam = this.asignaturas.filter((element) => {
